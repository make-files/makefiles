...
# GO_PROTO_FILES is a space separated list of Protocol Buffers files that
# need to be built into Go files.
GO_PROTO_FILES += $(shell git-find '*.proto')
